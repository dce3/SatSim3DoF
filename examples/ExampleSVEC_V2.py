"""
Script to retrieve the Voyager 2 state vector using the BSP file:
flight_ephems/Voyager_2.m05016u.merged.bsp.
According to published mission data, the Star-37E burn occurred at approximately 15:00 UTC
on August 20, 1977. In this example, an epoch is chosen slightly after the event
(15:32:33 UT plus an offset of 3600 seconds). This script also loads a planetary
ephemeris kernel (de440.bsp) and a leap-seconds kernel (naif0012.tls).
...
def main():
    ...
    voy2_kernel = "flight_ephems/Voyager_2.m05016u.merged.bsp"  # Voyager 2 BSP kernel
    leap_kernel = "ephems/naif0012.tls"      # Leap-seconds kernel
    ...
    et = spice.str2et(epoch_str) + 3600
    ...
    print("Voyager 2 state vector (J2000, relative to the Sun):")
